...
## 📽️ Full Demo
<video src="https://github.com/kh4c/SpriteLab-Studio/raw/master/Image/0419.mp4" controls width="100%"></video>
*Watch the high-fidelity demo of SpriteLab Studio in action.*

> 🔗 **Can't see the video player above?** [Click here to view the Full Demo video directly on GitHub](https://github.com/kh4c/SpriteLab-Studio/blob/master/Image/0419.mp4)

### 🎬 Demo Showcase
Here are the latest demo results generated by SpriteLab Studio:

#### 1. AI Keyframe Interpolation Loop (Idle to Defeated)
![AI Keyframe Interpolation Loop](./Image/results/result_1.gif)
*A pixel-art character transitioning from an idle standing pose to a defeated (lying down) pose, showcasing smooth keyframe interpolation inside the Animation Lab interface.*

#### 2. Real-Time Portal Effect Loop
![Real-Time Portal Effect Loop](./Image/results/result_2.gif)
*A swirling, high-fidelity blue portal animation with a green chroma-key background, displaying real-time VFX looping capabilities.*

#### 3. Real-Time Character Running Animation Loop
![Real-Time Character Running Animation Loop](./Image/results/result_3.gif)
*The character in a dynamic horizontal running loop, demonstrating real-time sprite processing.*

#### 4. Clean Character Idle Animation
![Clean Character Idle Animation](./Image/results/result_4.gif)
*A clean, isolated idle breathing animation of the character holding their rifle, stripped of editor overlays.*

#### 5. Outline Highlight & Contour Extraction (Walking Chocolate Bar)
![Outline Highlight & Contour Extraction](./Image/results/result_5.gif)
*A walking chocolate bar character, highlighting the precise edge detection and red outline contour extraction on a chroma-key green screen.*
---
