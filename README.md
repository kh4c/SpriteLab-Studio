...
#### 1. AI Keyframe Interpolation Loop
![AI Keyframe Interpolation Loop](./Image/results/result_1.gif)
*A pixel-art chibi maid character holding a rifle vertically, showcasing smooth keyframe interpolation inside the Animation Lab interface.*
...
#### 3. Real-Time Dynamic Maid Pose Loop
![Real-Time Dynamic Maid Pose Loop](./Image/results/result_3.gif)
*The chibi maid character in a dynamic shooting/running pose holding a rifle horizontally, demonstrating real-time sprite looping.*

#### 4. Clean Maid Idle Animation
![Clean Maid Idle Animation](./Image/results/result_4.gif)
*A clean, isolated idle animation of the chibi maid character holding her rifle, stripped of any editor overlays.*

#### 5. Outline Highlight & Contour Extraction
